...
responses = [
    ...
    ([
        ...
        "какая цена", "сколько стоит", "какая стоимость", "по чем", "почем", "есть?", "есть", "в наличии", "наличие", "наличия", "наличий" "поступление", "поступит", "поступили"
    ],
    ...
    ([
        "трудоустройство", "трудоустройства", "трудоустройств" "вакансия", "вакансий", "вакансии", "отдел кадров"
    ],
     "По вопросам трудоустройства, вы можете обратиться по номеру 8 (800) 222-15-05 (доб. 2)"),

    ([
        "франшиза", "франшиз", "франшизы", "франшизе", "франшизу", "франчайзинг", "франчайзингу", "франчайзинга", "франчайзинги", "франчайзи", "франчайзе"
    ],
     "По вопросам франшизы, вы можете обратиться на почту franchise@blacktab.ru или по номеру 8 (800) 222-15-05 (доб. 3)"),

    ([
        "жалоба", "жалобу", "жалоб", "жаловаться", "пожалуюсь", "жалобы", "пожаловаться", "обмен", "обмена" "обменять", "поменять", "вернуть", "возврат", "верните", "возвратите"
    ],
